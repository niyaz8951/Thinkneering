...
export function rowToNode(r) {
  return {
    ...
    // Scope defaults to 'project' for rows written before the column existed:
    // the conservative reading of an unlabelled fact, not the convenient one.
    scope: r.scope || 'project', origin: r.origin || 'human', sourceRef: r.source_ref || '',
