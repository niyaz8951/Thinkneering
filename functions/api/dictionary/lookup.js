...
async function generate(env, term, sentence, domain) {
  ...
  const system = [
    ...
    '- hindi: the word in Devanagari. urdu: the word in Urdu script.',
    '  urduRoman: how the Urdu form is read aloud, in roman letters.',
    '  Fill all three whenever a settled, commonly used equivalent exists.',
    '  Leave them empty for a word with no established Hindi or Urdu form.',
    '- origin: fill this whenever the history genuinely explains the word —',
    '  the Latin, Arabic, Persian or Sanskrit root and what it meant. This is',
    '  usually worth giving. Leave it empty only when the origin tells the',
