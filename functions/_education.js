  ...
  do {
    ...
    for (const obj of page.objects) {
      ...
      out.push({
        ...
        // The shelf this book was filed under. Books uploaded before the
        // field existed carry nothing, and the page groups those under
        // "Unsorted" rather than inventing a shelf for them.
        collection: decodeMeta(meta.collection) || '',
        format,
        size: obj.size,
