...
(function () {
  ...
  function tabBarHTML(sections) {
    ...
    var tabs = (sections || []).slice(0, 4).map(function (s) {
      ...
      var here = location.pathname === href || location.pathname.indexOf(href + '/') === 0;
  ...
  function footerHTML() {
    return '<div class="site-footer__inner">' +
      ...
      '<a href="/s/compliance-maker">Compliance Maker</a>' +
      '<a href="/s/maps">Maps</a>' +
      '<a href="/s/library">Library</a><a href="/account/">Account</a></nav>' +
      '</div>';
  }
