...
-- reports "duplicate column name" on the ALTERs — harmless, and it means
...
ALTER TABLE knowledge_nodes ADD COLUMN scope TEXT NOT NULL DEFAULT 'project';
ALTER TABLE knowledge_nodes ADD COLUMN project_id TEXT;
ALTER TABLE knowledge_nodes ADD COLUMN origin TEXT NOT NULL DEFAULT 'human';
ALTER TABLE knowledge_nodes ADD COLUMN source_ref TEXT;
