...
(function () {
  ...
  var RELATIONS = {
    /* The outline's tree: a topic contains the words under it. Present in
       every pack under the same name so the outline works the same way on a
       word map as on an equipment map. */
  ...
  window.TN_KG_ENGLISH = {
    ...
    relations: RELATIONS,
    /* What the outline view uses: the relation that means "is under", and
       the kind a line typed in the outline starts as. */
    outline: { relation: 'contains', defaultKind: 'word' },
    lanes: LANES,
    standards: [],
    seed: SEED
  };
